...
import { BehaviorSubject, combineLatest, fromEvent, interval, merge, Observable, of, race, Subject, timer } from 'rxjs';
import { filter, first, flatMap, map, mergeMap, startWith, switchMap, switchMapTo, takeUntil } from 'rxjs/operators';
